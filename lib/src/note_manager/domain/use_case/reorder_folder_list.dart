...
class ReorderFolderList
    extends UsecaseWithParams<List<FolderEntity>, List<FolderEntity>> {
  final NoteManagerRepo repo;

  ReorderFolderList({required this.repo});

  @override
  FutureResult<List<FolderEntity>> call(List<FolderEntity> param) async {
    return await repo.reorderFolderList(folders: param);
  }
}
